...
export default function Footer() {
    const [curentYears, setcurentYears] = useState<number>(
...
text-white px-4 mt-8 container   mx-auto
                    "
                        >
                              <div
                            className="grid md:grid-cols-2 lg:grid-cols-4 gap-8  py-14 
                 "
                        >
                            {/* PRIMMIO */}
                            <div>
                    ...
                    <div className="text-center mt-10 text-gray-400 text-sm">
                        Copyright © {curentYears} PRIMMIO — Plateforme de Recherche
                        Immobilière et de Mise en relation pour un Marché Inclusif et
                        Organisé
                    </div>
                </div>
